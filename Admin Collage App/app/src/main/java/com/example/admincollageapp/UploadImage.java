...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("VIIT: Add Image");
        ...
        String[] items = new String[]{"Select Category", "Convocation", "Independence Day", "AI and Data Science", "Civil Eng", "Computer Eng", "Electronics and Tele-Comm", "Eng and Applied Sciences", "IT", "Mechanical Eng", "Other Events"};
