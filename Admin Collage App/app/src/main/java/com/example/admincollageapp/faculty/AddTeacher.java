...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("VIIT: Add Faculty");
        ...
        String[] items = new String[]{"Select Category", "AI and Data Science", "Civil Engineering", "Computer Engineering", "Electronics and Tele-Comm", "Engineering and Applied Sciences", "Information Technology", "Mechanical Engineering"};
